...
<figcaption>your question lands near the chunks that answer it</figcaption>
</figure>
...
<figure class="fig">
<svg class="fig-svg" viewBox="0 0 560 100" role="img" aria-label="Pipeline: load to chunk to embed to retrieve to answer">
